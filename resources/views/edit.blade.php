 <div class ="row">
                                        ...
                                        <div class ="row">
                                            <div div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="name2" value="{{$formu->name2}}" placeholder="name@example.com" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class ="row">
                                            <div div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="email2" value="{{$formu->email2}}" placeholder="name@example.com" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="exampleFormControlInput1">Nick do player 2:</label>
                                                <input type="text" name="nick2" value="{{$formu->nick2}}"  class="form-control" required>
                                            </div>
                                        </div> 
                                            ...
                                            <div div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="name3" value="{{$formu->name3}}" placeholder="name@example.com" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="exampleFormControlInput1">Email do player 3:</label>
                                                <input type="text" name="email3" value="{{$formu->email3}}"  class="form-control" required>
                                            </div>
                                        </div>
                                         ...
                                         <div class ="row">
                                            <div div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="nick3" value="{{$formu->nick3}}" placeholder="name@example.com" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="exampleFormControlInput1">Nome do player 4:</label>
                                                <input type="text" name="name4" value="{{$formu->name4}}"  class="form-control" required>
                                            </div>
                                        </div>
                                         ...
                                         <div class ="row">
                                            <div div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="email4" value="{{$formu->email4}}" placeholder="name@example.com" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="exampleFormControlInput1">Nick do player 4:</label>
                                                <input type="text" name="nick4" value="{{$formu->nick4}}"  class="form-control" required>
                                            </div>
                                        </div> 
                                         ...
                                         <div class ="row">
                                            <div div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="name5" value="{{$formu->name5}}" placeholder="name@example.com" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="exampleFormControlInput1">Email do player 5:</label>
                                                <input type="text" name="email5" value="{{$formu->email5}}"  class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class ="row">
                                            <div div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="nick5" value="{{$formu->nick5}}" placeholder="name@example.com" required>
                                            </div>
                                      </div>
